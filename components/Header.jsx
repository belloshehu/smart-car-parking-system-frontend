...
const Header = () => {
    ...
    return (
        <div className='lg:hidden flex justify-between flex-row p-3 py-3 md:px-10 w-full bg-slate-500 shadow-lg fixed top-0 left-0 z-10'>
            <Link href='/' className='flex gap-2 items-center text-white hover:text-slate-300 transition-all duration-150'>
                ...
                <h3 className='text-xl md:text-2xl text-center brand-name'>Car parking system</h3>
            </Link>
