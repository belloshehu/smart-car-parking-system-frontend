  ...
  return (
    <div className='flex flex-col lg:items-start gap-4 mt-2 lg:mt-10 
                  text-white bg-slate-00 hover:bg-slate-00 
                    md:w-6/12 group transition-all duration-300 rounded-lg lg:text-left lg:justify-between'
    >
        ...
        <button className='shadow-lg p-4 flex bg-slate-900 items-center justify-center px-10 rounded-md gap-2' onClick={handleClick}>
